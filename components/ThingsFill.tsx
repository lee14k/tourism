          ...
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                Incredible adventure awaits
              </h1>
              <p className="mt-6 text-xl leading-8 text-gray-700">
                Enjoy the sights and adventures that await in tropical Taniti.
                From snorkeling to hiking, there is something for everyone.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              <p>
                ...
                bowling. Also, a nine-hole golf course should be operational by
                next year. Many of these activities are located in Merriton
                Landing, which is a rapidly developing area on the north side of
                Yellow Leaf Bay.
              </p>
