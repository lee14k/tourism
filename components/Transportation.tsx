    ...
    <div className="grid grid-cols-2">
      ...
      <div>
        ...
        <div>
          <ul>
            <li>
              Almost all visitors arrive to Taniti by air, though some arrive on
              a small cruise ship that docks in Yellow Leaf Bay for one night
              ...
              island within the next few years. Ground Transportation: Public
              ...
              Taniti City, and rental cars can be rented from a local rental
              ...
              surrounding Merriton Landing: this area is easy to explore on
              foot.
            </li>
          </ul>
        </div>
